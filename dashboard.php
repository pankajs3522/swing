...
<div>
<input type="submit" id="start" class="btn btn-primary btn-block" onclick='window.open("https://ctrides.000webhostapp.com/driver_listers.php?route=<?php echo $_SESSION['route']; ?>")' value="Start A Ride">
</div>
